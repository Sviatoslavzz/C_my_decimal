...
START_TEST(test_1) {
  ...
  my_decimal test_num = {{12, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
...
START_TEST(test_2) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{6, 0, 0, 0x80000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_6) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{7, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_7) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{4166118278, 42949672, 0, 0x80000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_10) {
  ...
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{199, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_12) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{124, 0, 0, 0x80000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_18) {
  ...
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{402263060, 176, 0, 0x80000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_20) {
  ...
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{42949672, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_21) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{9, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_25) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{793, 0, 0, 0x80000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_26) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{792281624, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_27) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{1073741825, 4037269258, 42949672, 0x80000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_29) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{3133608140, 429496, 0, 0x80000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
END_TEST
START_TEST(test_32) {
  my_decimal num1 = {{12983476, 0, 0, 0x001E0000}};
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{0, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
...
END_TEST
START_TEST(test_33) {
  my_decimal num1 = {{12983476, 0, 0, 0x05070001}};
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{0, 0, 0, 0x00000000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
...
START_TEST(test_34) {
  ...
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{100000, 0, 0, 0x00050000}};
  int error_code = my_floor(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
