...
START_TEST(test_1) {
  ...
  int error_code = my_truncate(num1, &num2);
...
START_TEST(test_5) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{7, 0, 0, 0x80000000}};
  int error_code = my_truncate(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_8) {
  ...
  my_decimal test_num = {{1234, 0, 0, 0x80000000}};
  int error_code = my_truncate(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_9) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{42949672, 0, 0, 0x80000000}};
  int error_code = my_truncate(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_14) {
  ...
  my_decimal num2 = {{0, 0, 0, 0}};
  my_decimal test_num = {{18446, 0, 0, 0x80000000}};
  int error_code = my_truncate(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
END_TEST
START_TEST(test_32) {
  my_decimal num1 = {{12983476, 0, 0, 0x01100000}};
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{0, 0, 0, 0x00000000}};
  int error_code = my_truncate(num1, &num2);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
...
START_TEST(test_33) {
  ...
  my_decimal num2 = {{0, 0, 0, 0x00000000}};
  my_decimal test_num = {{0, 0, 0, 0x00000000}};
  int error_code = my_truncate(num1, NULL);
  ck_assert_msg(my_is_equal(num2, test_num) == 1, "my_is_equal failed");
  ck_assert_int_eq(error_code, 1);
}
END_TEST
